...
export default function Contact() {
  ...
  return (
    <Layout title="Contact | Bhekumusa Eric Ntshwenya">
      {/* Hero Section */}
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:bhntshwcjc025@student.wethinkcode.co.za" className="text-gray-300 hover:text-primary transition-colors">
                  ...
                  <div className="flex space-x-4">
                    {socialLinks.map((link, index) => (
                      <motion.a
                        ...
                        className="bg-gray-800 p-3 rounded-full text-gray-400 hover:text-primary hover:bg-gray-700 transition-colors"
                        whileHover={{ y: -5 }}
                        whileTap={{ y: 0 }}
              ...
              <div className="glass-effect p-8 rounded-lg">
                ...
                {submitStatus === 'success' && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-green-500 bg-opacity-20 text-green-400 p-4 rounded-lg mb-6"
                  >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-gray-300 focus:outline-none focus:border-primary transition-colors"
